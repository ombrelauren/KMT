...
export default function AboutPage({ about }: { about: AboutContent }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white" style={{ paddingTop: HEADER_HEIGHT }}>
      <HeaderBackdrop />
      {/* No title anymore — the whole text block (paragraph, contacts,
          socials) is centered in the full space below the header. */}
      <div className="flex flex-1 flex-col items-center justify-center px-page pb-[100px] text-center">
